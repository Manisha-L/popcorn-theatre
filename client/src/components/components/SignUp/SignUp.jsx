    ...
    return(
        <div className="signin-container">
            <div className="signin">
                <div className="loginreglogo">
                 <img class="loginlogo" src={Popcorn} alt=""/>
                </div>
                <h3>Register</h3>
                <a name="#top" id="top"></a>
                <form onSubmit={handelSubmit} autocomplete="off">
                    ...
                    <div className="inputField">
                        ...
                        <div className="showPassword" id="showPassEye" onClick={togglePassword} ><FaEye className="showPassEye"/></div>
                    ...
                    <div className="inputField">
                        ...
                        <div className="showPassword" id="showPassEye" onClick={togglePassword2} ><FaEye className="showPassEye"/></div>
                        {/* <span className={ showTooltip ? "tooltip" : "tooltip notvisible"} >Show Password</span> */}
                    </div>
                    {/* <GenerPreference />           */}
