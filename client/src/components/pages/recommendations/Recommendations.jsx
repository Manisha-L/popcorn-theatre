                ...
                {!isAuthenticated &&<Link to="/signin">Sign in to Get Recommendations</Link>}
                    {
                        ...
                        :   
                    <div >
                            <button onClick={generateCollaborativeFilteringRecommendations} value="userBasedCF" className="generateRecBtn">New User Cold Start</button>
                            <button onClick={generateCollaborativeFilteringRecommendations} value="itemBasedCF" className="generateRecBtn">New Item Cold Start</button>
                    </div>
                    }
            </div>
        </div>)
