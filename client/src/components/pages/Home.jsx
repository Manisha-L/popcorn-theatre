...
const Home =  () =>{
    ...
    return (
       <div>
           ...
           <Selections handelClick={handelClick} collections={["Trending",  "Movies You May Like"]}/>
           {selection ==="Trending" && <Grid header={searchTerm ? "Search Results:" : "Trending"}>
           ...
           {/* {selection==="Feed" && <Feed />} */}
           {selection==="Movies You May Like" && <Recommendation/>}
           {loading && <Spinner /> }
